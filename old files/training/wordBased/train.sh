...
LABEL_SMOOTHING=0.1
SAVE_DIR="/local/musaeed/coptic-translator/checkpointWordBasedPCM/English2CopticWordBasedSeq2SeqTransformer"
...
fairseq-train "/local/musaeed/coptic-translator/fairseqwordBased/en_coptic.tokenized.en-coptic"\
    --arch "transformer" \
    --dropout $DROPOUT \
