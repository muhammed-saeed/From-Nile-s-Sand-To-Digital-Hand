...
TARGET_LANGUAGE="en"
TRAIN_PREF="/local/musaeed/From-Nile-s-Bank-to-Digital-Hand/CopEng/Dataset/train/train"
VALID_PREF="/local/musaeed/From-Nile-s-Bank-to-Digital-Hand/CopEng/Dataset/val/val"
TEST_PREF="/local/musaeed/From-Nile-s-Bank-to-Digital-Hand/CopEng/Dataset/test/test"
COPTIC_EN_DEST_DIR="/local/musaeed/From-Nile-s-Bank-to-Digital-Hand/CopEng/FairSEQ/Wordbased/coptic_en.tokenized.coptic-en"
EN_COPTIC_DEST_DIR="/local/musaeed/From-Nile-s-Bank-to-Digital-Hand/CopEng/FairSEQ/Wordbased/en_coptic.tokenized.en-coptic"
SRC_THRES=0
TGT_THRES=0
